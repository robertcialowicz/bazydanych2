# Generated by Django 2.2 on 2020-12-01 05:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('freight', models.DecimalField(blank=True, db_column='Freight', decimal_places=4, max_digits=19, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('customerid', models.ForeignKey(db_column='CustomerID', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='myapi.Customers')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('employeeid', models.ForeignKey(db_column='EmployeeID', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='myapi.Employees')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='OrderDetails',
            fields=[
                ('orderid', models.ForeignKey(db_column='OrderID', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='myapi.Orders')),
